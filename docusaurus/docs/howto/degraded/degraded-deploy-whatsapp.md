...
1. Add the dependencies for using the bot with Whatsapp.

```bash
npm install wechaty-puppet-whatsapp
```

1. Create a new folder `src` and add a file `my-bot.js`. Add your custom functions to the code snippet below:
