...
Running your wechaty as a hostie requires `WECHATY_TOKEN` so as to manage wechaty on the chatbot cloud manager: [https://www.chatie.io](https://www.chatie.io)
...
3. Docker Wechaty GitHub repo: [https://github.com/wechaty/docker-wechaty-getting-started](https://github.com/wechaty/docker-wechaty-getting-started)
